...
@hotel1 = Hotel.create!( name: 'Hotel 1', address: 'Address 1', city: 'City 1', country: 'Egypt', room_price: 20, pet_friendly: true, number_of_rooms: 11 , stars: 4, current_free_rooms: 1, user_id: @user1.id)
